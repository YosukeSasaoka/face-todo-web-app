...
namespace faceTodoApplication.Controllers
{
    public class TodoController : Controller
    {
        ...
        public TodoController(TodoesContext context,IOptions<AzureStorageConfig> appOptions)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,URL")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,URL")] Todo todo)
        {
            if (id != todo.ID)
            {
                return NotFound();
